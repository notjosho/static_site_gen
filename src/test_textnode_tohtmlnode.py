...
from helperfunctions import text_node_to_leaf_node
...
class TestTextNodeToHtmlNode(unittest.TestCase):
  def test_simple_types(self):
    ...
    html_node_normal = text_node_to_leaf_node(text_node_normal)
    ...
    html_node_bold = text_node_to_leaf_node(text_node_bold)
    ...
    html_node_italic = text_node_to_leaf_node(text_node_italic)
    ...
    html_node_code = text_node_to_leaf_node(text_node_code)
  ...
  def test_node_props_types(self):
    ...
    html_node_links = text_node_to_leaf_node(text_node_links)
    ...
    html_node_images = text_node_to_leaf_node(text_node_images)
  ...
  def test_node_type_error(self):
    ...
    with self.assertRaises(ValueError) as context:
      ...
      html_node = text_node_to_leaf_node(text_node)
